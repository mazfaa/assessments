                    ...
                    <div class="mb-6">
                        ...
                        <table class="table w-1/2 mt-4">
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>Rp. {{ str_replace(',', '.', number_format($transaction->total_price, 2)) }}</td>
                            </tr>
                        </table>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($transaction_item as $index => $transaction)
                                        ...
                                        <tr class="border-t">
                                            ...
                                            <td class="px-4 py-2">Rp.
                                                {{ str_replace(',', '.', number_format($product->price, 2)) }}</td>
                                            <td class="px-4 py-2">{{ $transaction->quantity }}</td>
                                            <td class="px-4 py-2">
                                                Rp.
                                                {{ str_replace(',', '.', number_format($product->price * $transaction->quantity, 2)) }}
                                            </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-4 py-2 bg-gray-900 text-white">
                                            Rp. {{ str_replace(',', '.', number_format($total_price, 2)) }}
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
