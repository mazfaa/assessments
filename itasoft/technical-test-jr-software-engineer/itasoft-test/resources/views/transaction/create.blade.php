                ...
                <div class="form-group flex items-center gap-x-2">
                  <div class="w-1/2">
                    ...
                    <select name="products[0][id]"
                      class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full select-product-form" id="product-select-form">
                  ...
                  <div class="w-1/2">
                    ...
                    <input type="number" name="products[0][quantity]"
                      ...
                      value="{{ old('products[0][quantity]', 1) }}" autocomplete="off" placeholder="Quantity" id="quantity-form" min="1" required>
                  </div>
                </div>
              </div>
  ...
  <x-slot name="scripts">
    <script>
      document.addEventListener('DOMContentLoaded', function () {
        document.getElementById('total-price-transaction').innerText = '{{ $products[0]->price }}'
        ...
        function updateTotalPrice() {
          ...
          document.getElementById('total-price-transaction').innerText = `$${totalPrice.toFixed(2)}`;
